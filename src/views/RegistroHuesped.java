...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHuesped.class.getResource("/imagenes/oracle-icon.png")));
		...
		txtNombre.setBackground(new Color(128, 128, 128));
		...
		txtApellido.setBackground(new Color(128, 128, 128));
		txtApellido.setBorder(javax.swing.BorderFactory.createEmptyBorder());
		contentPane.add(txtApellido);
		
		txtFechaN = new JDateChooser();
		txtFechaN.setBackground(new Color(128, 128, 128));
		txtFechaN.setForeground(new Color(255, 255, 255));
		...
		txtFechaN.getCalendarButton().setBackground(new Color(0, 0, 0));
		txtFechaN.setDateFormatString("yyyy-MM-dd");
		contentPane.add(txtFechaN);
		
		txtNacionalidad = new JComboBox();
		txtNacionalidad.setForeground(new Color(0, 0, 0));
		txtNacionalidad.setBounds(560, 350, 289, 36);
		txtNacionalidad.setBackground(new Color(169, 169, 169));
		...
		lblNacionalidad.setForeground(new Color(211, 211, 211));
		lblNacionalidad.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		contentPane.add(lblNacionalidad);
		
		JLabel lblTelefono = new JLabel("TELÉFONO");
		lblTelefono.setBounds(562, 406, 253, 14);
		lblTelefono.setForeground(new Color(211, 211, 211));
		...
		imagenFondo.setBounds(0, 141, 489, 513);
		panel.add(imagenFondo);
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/imagenes/oraclerb.jpg")));
		
		JLabel lblNewLabel_4 = new JLabel("REGISTRO HUÉSPED");
		lblNewLabel_4.setBounds(115, 65, 275, 42);
