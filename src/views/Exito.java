...
public class Exito extends JDialog {
	...
	public Exito() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Exito.class.getResource("/imagenes/oracle-icon.png")));
		setBounds(100, 100, 394, 220);
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Exito.class.getResource("/imagenes/oraclet.png")));
